...
public class IndiaT20Performance {
	private static StringBuffer csv_data = new StringBuffer();
	private static StringBuffer matchData = new StringBuffer();
	private static final String[] teams = { "India" };
	private static final String[] months = { "JAN", "FEB", "MAR", "APR", "MAY",
			"JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" };

	static int count = 0;
	static int t20count = 0;
	...
	public static void main(String... args) throws IOException {
		...
		Files.write(
				Paths.get("/home/nidhin/Desktop/POCCricket/indiat20performance.csv"),
	...
	private static void convertFile(Path filePath, String teamName) {
		...
		try {
			...
			if ((firstTeam.equalsIgnoreCase(teamName) || secondTeam
					.equalsIgnoreCase(teamName)) && matchType.equals("T20")) {
